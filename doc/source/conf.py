...
cmd = ["sphinxdoc", "-v 2", "-p",  installdir, "-n", "brainprep", "-o", "..",
       "-i", "brainprep"]
...
html_title = "brainprep"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "brainprep"
...
# [howto/manual]).
latex_documents = [
    ("index", "brainprep.tex", "brainprep Documentation", """brainprep developers""",
     "manual"),
]
